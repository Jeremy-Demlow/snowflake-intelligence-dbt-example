-- ACME Intelligence Agent - Generated from Python Configuration
-- Modular, scalable, and maintainable approach
...
FROM SPECIFICATION $${
  ...
  "instructions": {
    ...
    "orchestration": "Use 'Query Operational Data' for questions about technicians, jobs, and operational revenue. Use 'Query Financial Metrics' for NDR, ARR expansion, customer segments, and financial analytics.",
    "sample_questions": [
      {
  ...
  "tools": [
    ...
    },
    {
      "tool_spec": {
        "type": "generic",
        "name": "Send_Email",
        "description": "Send emails to recipients with subject and HTML content",
        "input_schema": {
          "type": "object",
          "properties": {
            "recipient": {
    ...
    },
    {
      "tool_spec": {
        "type": "generic",
        "name": "Web_scrape",
        "description": "Scrape and analyze websites for competitive intelligence",
        "input_schema": {
          "type": "object",
          "properties": {
            "url": {
