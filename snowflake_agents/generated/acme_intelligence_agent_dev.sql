...
FROM SPECIFICATION $${
  ...
  "tool_resources": {
    "Query Operational Data": {
      "semantic_view": "ACME_INTELLIGENCE.SEMANTIC_MODELS.acme_semantic_view",
    ...
    "Query Financial Metrics": {
      "semantic_view": "ACME_INTELLIGENCE.SEMANTIC_MODELS.acme_financial_semantic_view",
      "execution_environment": {
        "type": "warehouse",
        "warehouse": "HOL_WAREHOUSE"
      }
